...
def per_img_scores_ours(clss_dist_ri, clsses_dist_r_expi, clss_dist_si, clsses_dist_s_expi, loader_si, metric_id):
    fid_score = {}
...
def per_img_scores_oursV2(clss_dist_ri, clsses_dist_r_expi, clss_dist_si, clsses_dist_s_expi, loader_si,
    ...
    for i, (images, labels, image_paths) in enumerate(loader_si):
        ...
        for img_ind, score in enumerate(scores):
            ...
            # print(img_ind)
            # print(fid_score[image_paths[img_ind]], features_consist, image_paths[img_ind])
